...
export default {
    ...
    theme: {
        ...
        fontFamily: {
            sans: ["Cairo-Regular", "Cairo-Light", "Cairo-Bold"],
            serif: [
                'Cairo-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',
                "serif",
            ],
            body: ["Cairo-Bold", "sans-serif"],
            awesome: ["FontAwesome"],
        },
        fontSize: ({ theme }) => ({
            ...theme("spacing"),
